...
| Build Safety Net | n days | n hours | Characterization tests, baseline metrics |
| Implement Services | n days | n hours | All microservices, REST APIs, tests |
| OpenShift Setup | n day | n hours | Helm charts, K8s manifests, CI/CD pipeline |
| E2E Testing | n days | n hours | Playwright test suite, performance tests |
| Strangler Facade | n day | n hours | API gateway, traffic routing, feature flags |
